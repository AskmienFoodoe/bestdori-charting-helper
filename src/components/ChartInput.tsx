...
import { Form, TextArea, Input, Dropdown, Label, DropdownProps, InputOnChangeData, Button, ButtonProps, Message } from 'semantic-ui-react'
...
export default class ChartInput extends React.Component<propsType, stateType> {
    ...
    getChartFromApi = async () => {
        ...
        try {
            ...
            this.setState({ inputChart: JSON.stringify(newChart.chartElements), errorMessage: '' }, this.updateChartInContext)
        } catch (err) {
